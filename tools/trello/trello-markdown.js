/**
 * COPILOT & DEVELOPER INSTRUCTION
 *
 * This script MUST keep tools/trello/trello-board-mirror.md and the Trello board in perfect sync.
 * Any change to either must be reflected in both, immediately.
 * This file is NOT static documentation—treat as the live project board.
 * Never move or rename trello-board-mirror.md.
 * Run this script after any change, and always before any major commit or pull request.
 */
// trello-markdown.js
// Fetches all lists and cards from a Trello board and outputs as Markdown
// Usage: node tools/trello/trello-markdown.js
...
(async () => {
  try {
    ...
    fs.writeFileSync('tools/trello/trello-board-mirror.md', md, 'utf8');
    console.log('Markdown file written: tools/trello/trello-board-mirror.md');
  } catch (err) {
