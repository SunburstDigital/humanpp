<!--
  COLUMN: Ideas & Research
  FILE: ideas-and-research.md
  PURPOSE: Mirrors the "Ideas & Research" column in Trello. All cards/issues from this column will appear here in strict project formatting.
  FORMATTING RULES:
