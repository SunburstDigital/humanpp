# humanpp-prod.ps1
# Full smoke test harness for Sunburst Voice System (Fastify - Fly prod)

$baseUrl = "https://sunburst-voice.fly.dev"
Write-Host "🔄 Running Sunburst Voice System smoke test (PROD) against $baseUrl`n"
...
$smsBody = @{
    SmsSid   = "SMPROD123456789"
    From     = "+61411111111"
    To       = "+61422222222"
    Body     = "Hi, do you have any 3x2 rentals in Bayswater?"
    MessageSid = "SMPROD123456789"
}
...
Write-Host "`n✅ PROD smoke test complete."
